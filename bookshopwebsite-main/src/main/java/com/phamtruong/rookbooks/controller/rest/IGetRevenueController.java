package com.phamtruong.rookbooks.controller.rest;
...
public interface IGetRevenueController {
    ...
    @Operation(summary = "Categories Revenue", description = "Find top 10 books's buy count")
    @GetMapping("/get-revenue/book-by-quantity/{selectedValue}")
    ResponseEntity<?> getBookByBuyCount(@PathVariable("selectedValue") String selectedValue) throws UnsupportedEncodingException;
