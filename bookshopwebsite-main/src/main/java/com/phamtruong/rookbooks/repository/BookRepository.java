...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    Page<Book> findByTitleContainingAndOriginalPriceBetweenAndActiveFlagOrderByCreatedAtAscIdAsc(String title, double minPrice, double maxPrice, boolean activeFlag, Pageable pageable);

    Page<Book> findByTitleContainingAndOriginalPriceBetweenAndActiveFlagOrderByCreatedAtDescIdDesc(String title, double minPrice, double maxPrice, boolean activeFlag, Pageable pageable);
    ...
    List<Book> findByActiveFlagOrderByBuyCountDesc(boolean activeFlag);

    List<Book> findTop10ByActiveFlagOrderByBuyCountDescIdDesc(boolean activeFlag);

    List<Book> findTop10ByActiveFlagOrderByBuyCountAscIdDesc(boolean activeFlag);
    ...
    List<Book> findTop4ByCategoryIdAndActiveFlag(Long id, boolean b);
}