...
public class MockChatbotServiceImpl {
    ...
    static {
        ...
        PREDEFINED_RESPONSES.put(
                ...
                "Xin chào! Tôi là trợ lý sách của Ann Books. Bạn đang tìm kiếm sách gì? Tôi có thể giúp bạn tìm sách theo thể loại, tác giả, hoặc chủ đề bạn quan tâm."
        );
